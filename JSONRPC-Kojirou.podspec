#
#  Be sure to run `pod spec lint JSONRPC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "JSON-RPC framework"
  ...
  # Or just: s.author    = "Kojirou"
  # s.authors            = { "Kojirou" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Kojirou"
